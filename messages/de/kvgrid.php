...
return [
    ...
    'Failed to update editable data due to an unknown server error' => 'Fehler beim Aktualisieren von bearbeitbaren daten aufgrund eines unbekannten serverfehlers',
    'Grid Export' => 'Gitter Export',
    'Hyper Text Markup Language' => 'Hyper Text Markup Language',
    'Invalid editable index or model form name' => 'Ungültige bearbeitbare index oder modellformularname',
    'Invalid or bad editable data' => 'Ungültige oder fehlerhafte bearbeitbare daten',
    'JSON' => 'JSON',
