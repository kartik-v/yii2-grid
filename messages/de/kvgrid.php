...
return [
    ...
    'ExportWorksheet' => '',
    'Failed to update editable data due to an unknown server error' => 'Speichern fehlgeschlagen wegen eines unbekannten Serverfehlers',
    'Grid Export' => 'Tabellen-Export',
    'Hyper Text Markup Language' => '',
    'Invalid editable index or model form name' => '',
    'Invalid or bad editable data' => 'Ungültige Daten',
    'JSON' => 'JSON',
    ...
    'Tab Delimited Text' => '',
    'Text' => 'Text',
    'Total <b>{count, number}</b> {count, plural, one{{item}} other{{items}}}.' => 'Gesamt <b>{count, number}</b> {count, plural, one{{item}} other{{items}}}.',
    ...
    'PDF export generated by kartik-v/yii2-grid extension' => 'PDF-Export erstellt von kartik-v/yii2-grid-extension',
    'Page' => 'Seite',
    ...
    'Resize table columns just like a spreadsheet by dragging the column edges.' => 'Ändern Sie die Größe von Tabellenspalten, indem Sie die Spaltenränder verschieben.',
