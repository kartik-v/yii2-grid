...
return [
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{{item}} few{{items-few}} many{{items-many}} other{{items}}}.' => '{totalCount} 중 {begin} 에서 {end} 까지 표시하고 있습니다.',
    'Tab Delimited Text' => '',
    'Text' => '',
    ...
    'Total <b>{count, number}</b> {count, plural, one{{item}} few{{items-few}} many{{items-many}} other{{items}}}.' => '모두 {count} 개',
    'Update' => '',
    'View' => '',
